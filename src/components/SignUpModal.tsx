      ...
      >
        {!role ? (
          ...
          <>
            ...
            {/* Social Sign Up */}
            <button className="w-full flex items-center justify-center border px-4 py-2 rounded-lg mt-4 hover:bg-gray-100 dark:hover:bg-gray-800">
              🍏 Continue with Apple
            </button>
            <button className="w-full flex items-center justify-center border px-4 py-2 rounded-lg mt-2 hover:bg-gray-100 dark:hover:bg-gray-800">
